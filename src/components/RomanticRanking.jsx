                    ...
                    >
                        {filteredPosts.map((post, index) => (
                            <motion.div
                                ...
                                className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-pink-100 aspect-square flex flex-col"
                            >
                                ...
                                <div className="p-2 md:p-6 flex-shrink-0">
                                    ...
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="font-medium text-gray-800 text-sm truncate">{post.user.name}</p>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            ...
                                            <span className="text-sm md:text-base font-medium">{post.likes}</span>
                                        </motion.button>
                                        ...
                                        >
                                            ...
                                            <span className="text-sm md:text-base font-medium">{post.bookmarks}</span>
                                        </motion.button>
                                    </div>
                                </div>
                            </motion.div>
