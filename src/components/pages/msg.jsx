    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-medium text-gray-900 mb-3">{t('messages.pleaseLogin')}</h2>
          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.length > 0 ? (
              ...
              <div className="p-6 text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-2">{t('messages.noConversations')}</h3>
                <p className="text-sm text-gray-500 mb-6">{t('messages.startChatting')}</p>
                
                {/* Quick Start Demo Chat */}
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-200 rounded-lg p-4 mb-4">
                  <h4 className="font-medium text-gray-800 mb-2">{t('messages.tryDemoChat')}</h4>
                  <p className="text-sm text-gray-600 mb-3">{t('messages.demoDescription')}</p>
                  <button 
                  ...
                  >
                    ...
                    <span>{t('messages.startDemoChat')}</span>
                  </button>
                </div>
            ...
            <>
              ...
              <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-500">{t('messages.online')}</p>
                  </div>
                </div>
              ...
              <div className="bg-white border-t border-gray-200 p-4 sticky bottom-20">
                  ...
                  >
                    {isLoading ? (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">{t('messages.sending')}</span>
                      </div>
                    ) : (
                ...
                <div className="text-xs text-gray-500 mt-2 text-center">
                  Enterキーで送信 • {activeChat.userName}とチャット中
                </div>
              </div>
            </>
          ) : (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg max-w-sm">
                <p className="text-sm text-blue-700 text-center">
                  💡 <strong dangerouslySetInnerHTML={{ __html: t('messages.tip') }}></strong>
                </p>
              </div>
              ...
              <div className="mt-8 w-full max-w-md bg-white rounded-lg border border-gray-200 overflow-hidden">
                ...
                <div className="p-4 max-h-40 overflow-y-auto bg-gray-50">
                  <div className="text-sm text-gray-500 text-center mb-2">{t('messages.testMessages')}</div>
                  {messages.length > 0 && (
                ...
                >
                  <div className="p-4 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                      <h3 className="text-lg font-semibold text-gray-900">{t('messages.send')}</h3>
                      <button
                    ...
                    <p className="text-sm text-gray-500 mt-1">{t('messages.browseUsers')}</p>
                  </div>
                  ...
                  <div className="p-4 max-h-72 overflow-y-auto">
                    {availableUsers.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400 mt-2">{t('messages.startChatting')}</p>
