...
export const genreData = [
    { name: 'Amateur', count: '410,177 posts', color: 'from-pink-500 to-purple-600' },
    { name: 'Personal Filming', count: '147,577 posts', color: 'from-purple-500 to-indigo-600' },
    { name: 'Married Woman', count: '104,474 posts', color: 'from-red-500 to-pink-600' },
    { name: 'Large Breasts', count: '96,852 posts', color: 'from-orange-500 to-red-600' },
    { name: 'Pervert', count: '83,925 posts', color: 'from-green-500 to-teal-600' },
    { name: 'Home Video', count: '72,199 posts', color: 'from-blue-500 to-purple-600' },
    { name: 'Beautiful Woman', count: '65,989 posts', color: 'from-pink-500 to-red-600' },
    { name: 'Beautiful Breasts', count: '60,114 posts', color: 'from-purple-500 to-pink-600' }
];
...
const GenrePage = () => {
    ...
    const [activeGenre, setActiveGenre] = useState(genreName || 'Amateur');
                ...
                <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200 sticky top-0 z-10">
                    ...
                    <div className="flex-1 mx-3">
                        <div className="flex items-center bg-gray-100 rounded-full px-3 py-2">
                            ...
                            <span className="text-pink-600 text-sm font-medium mr-2">🎀 Amateur</span>
                            <input
                                type="text"
