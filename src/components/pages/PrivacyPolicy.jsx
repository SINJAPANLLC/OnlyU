        ...
        <div className="min-h-screen bg-white">
            ...
            >
                <div className="text-left space-y-6">
                    {/* Article Header */}
                    <h2 className="text-xl font-bold text-black mb-4">第1条（総則）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第2条（本ポリシーへの同意、同意の撤回）</h2>
                    ...
                    <ol className="space-y-4">
                        ...
                        <li className="flex">
                            <span className="text-black font-medium mr-2 flex-shrink-0">4.</span>
                            <p className="text-black leading-relaxed">
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第3条（収集するプライバシー情報）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第4条（プライバシー情報の利用目的）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第5条（プライバシー情報の第三者提供）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第6条（プライバシー情報の管理、保管期間）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第7条（ユーザーによる照会等への対応）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第8条（解析ツール等の使用）</h2>
                    ...
                    <ol className="space-y-4">
                        <li className="flex">
                            ...
                            <div className="text-black leading-relaxed">
                                ...
                                <br />
                                <a href="https://policies.google.com/privacy?hl=ja" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第9条（本ポリシーの変更）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第10条（合意管轄、準拠法）</h2>
                    ...
                    <h2 className="text-xl font-bold text-black mb-4">第11条（管理責任者）</h2>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mt-8">
                    <p className="text-sm text-gray-600">
                        ...
                        本ポリシーに関するご質問は、{' '}
                        <a href="mailto:kanagawa@sinjapan.jp" className="text-blue-600 hover:underline">
