...
import { Settings, FileText, MoreHorizontal, CreditCard, UserCheck } from 'lucide-react';
            ...
            >
                ...
                <div className="px-4 mt-8">
                    ...
                    <div className="border rounded-lg divide-y divide-gray-200">
                        ...
                        <button className="flex justify-between items-center py-3 px-4 hover:bg-gray-50 w-full text-gray-800" onClick={() => handleNavigation('/referral-program')}>{t('account.settings.referralProgram')}</button>
